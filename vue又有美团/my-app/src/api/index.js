...
var api = {
    searchHotWords(params) {
        return axios
            .get("/api/meituan/header/searchHotWords.json",params);
    },
    getSearchList() {
        return axios
    ...
    getHotCity(){
        return axios
            .get("/api/meituan/city/hot.json");
    },
    getRecentCity(){
        return axios
            .get("/api/meituan/city/recents.json");
    },
    getRrovinceList(){
        return axios
    ...
    getCurPosition(){
        return axios
            .get("/api/meituan/city/getPosition.json");
    },
    getCityList(){
        return axios
            .get("/api/meituan/city/cityList.json");
    }
}
